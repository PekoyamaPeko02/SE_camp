...
right text-sm text-warning"><i
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <span class="badge badge-warning navbar-badge">127</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <span class="dropdown-header">127 Notifications</span>
                        <div class="dropdown-divider"></div>
                        <a href="#" class="dropdown-item">
...
divider"></div>
                        <a href="#" class="dropdown-item">
                            <i class="fas fa-users mr-2"></i> 127 friend requests
...
dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ url('assets/dist/img/user2-160x160.jpg') }}" class="img-
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <center><h1 class="m-0">Workshop #HTML - FORM</h1></center>
                    <br>
                    ...
                    <form>
                        <table>
                            ...
                            <tr>
                                ...
                                <label for="agree">ยินยอมให้เก็บข้อมูล</label></td>
                            </tr>
                            <tr>
                                <td><br /></td>
                            </tr>
                            <tr>
                                <td><input type="reset" style="background-color: rgb(239, 89, 89)">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                    <input type="submit" style="background-color: rgb(73, 249, 73) " ></td>
